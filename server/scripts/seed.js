...
async function seed() {
  ...
  const testDemoUsers = [
    ...
    { title: 'Dr. Öğr. Üyesi', full_name: 'Aslıhan Ekşi', email: 'aslihaneksi@ogr.iu.edu.tr', bio: 'Biyomedikal Teknolojiler, Klinik Araştırmalar ve Sağlık Veri Madenciliği araştırmacısı.', photo_url: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&auto=format&fit=crop&q=80' }
  ];
