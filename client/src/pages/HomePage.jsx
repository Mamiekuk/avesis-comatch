      ...
      <section style={{ maxWidth: '1240px', margin: '0 auto 4.5rem', padding: '0 1.5rem' }}>
        ...
        <div className="card-glass" style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '0.88rem', color: 'var(--text-secondary)', lineHeight: 1.55, margin: 0 }}>
                1.233 akademisyenimizin yayın, atıf, h-indeksi ve proje metrikleri <strong>K-Means makine öğrenimi</strong> ile analiz edilerek 4 ana profilde derecelendirilir.
              </p>
            </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.82rem', fontWeight: 700, color: '#e879f9', marginBottom: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
              📊 Yapay Zeka Performans Profilleri Dağılım Tablosu
            </div>
            ...
            <table style={{
              ...
              <thead>
                <tr style={{ background: 'var(--bg-secondary)', borderBottom: '1px solid var(--border-color)', color: 'var(--text-primary)' }}>
                  <th style={{ padding: '0.65rem 0.9rem', fontWeight: 700, borderRadius: '8px 0 0 8px' }}>Profil İsmi</th>
                  <th style={{ padding: '0.65rem 0.9rem', fontWeight: 700 }}>Üye Sayısı</th>
                  <th style={{ padding: '0.65rem 0.9rem', fontWeight: 700, borderRadius: '0 8px 8px 0' }}>Özellik & Kriterler</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ borderBottom: '1px solid rgba(248, 250, 252, 0.06)' }}>
                  <td style={{ padding: '0.75rem 0.9rem', fontWeight: 700, color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>
                    🏆 Proje & Araştırma Lideri
                  </td>
                  <td style={{ padding: '0.75rem 0.9rem', fontWeight: 700, color: 'var(--accent-primary)', whiteSpace: 'nowrap' }}>
                    7 Araştırmacı
                  </td>
                  <td style={{ padding: '0.75rem 0.9rem', color: 'var(--text-secondary)', lineHeight: 1.4 }}>
                    Yüksek proje deneyimi, güçlü atıf/yayın altyapısı sunan, projelere yürütücülük yapabilecek en üst segment akademik liderler.
                  </td>
                </tr>
                ...
                <tr style={{ borderBottom: '1px solid rgba(248, 250, 252, 0.06)' }}>
                  ...
                  <td style={{ padding: '0.75rem 0.9rem', color: 'var(--text-secondary)', lineHeight: 1.4 }}>
                    H-indeksi ve uluslararası atıf sayıları ile alanında ekol olmuş, makale odaklı kıdemli araştırmacılar.
                  </td>
                </tr>

                <tr style={{ borderBottom: '1px solid rgba(248, 250, 252, 0.06)' }}>
                  <td style={{ padding: '0.75rem 0.9rem', fontWeight: 700, color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>
                    📈 Aktif Akademik Yayıncı
                  </td>
                  <td style={{ padding: '0.75rem 0.9rem', fontWeight: 700, color: 'var(--accent-primary)', whiteSpace: 'nowrap' }}>
                    292 Araştırmacı
                  </td>
                  <td style={{ padding: '0.75rem 0.9rem', color: 'var(--text-secondary)', lineHeight: 1.4 }}>
                    Sürekli yayın üreten, dengeli akademik performans ve proje katkısı sunan araştırmacılar.
                  </td>
                </tr>

                <tr>
                  <td style={{ padding: '0.75rem 0.9rem', fontWeight: 700, color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>
                    🚀 Yükselen Araştırmacı
                  </td>
                  <td style={{ padding: '0.75rem 0.9rem', fontWeight: 700, color: 'var(--accent-primary)', whiteSpace: 'nowrap' }}>
                    872 Araştırmacı
                  </td>
                  <td style={{ padding: '0.75rem 0.9rem', color: 'var(--text-secondary)', lineHeight: 1.4 }}>
                    Kariyerinin gelişim ve yükseliş aşamasında olan, potansiyeli yüksek genç ve dinamik akademisyenler.
                  </td>
                </tr>
              </tbody>
            </table>
